...
async function SCCreateNonFungibleToken() {
  ...
  let NFTCreator = require("./contracts/artifacts/NFTCreator.json");
  ...
  // NOTE:  We will mint each individual NFT under this single tokenId using mintNft()
  ...
  // Once executed, a new NFT will be minted and stored in the token treasury’s account.
